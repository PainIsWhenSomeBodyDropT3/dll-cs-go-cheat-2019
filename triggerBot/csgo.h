...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DA2E74;
	constexpr ptrdiff_t dwForceAttack = 0x31D4404;
	constexpr ptrdiff_t dwForceAttack2 = 0x31D4410;
	constexpr ptrdiff_t dwForceBackward = 0x31D43BC;
	constexpr ptrdiff_t dwForceForward = 0x31D43C8;
	constexpr ptrdiff_t dwForceJump = 0x524CDD4;
	constexpr ptrdiff_t dwForceLeft = 0x31D43E0;
	constexpr ptrdiff_t dwForceRight = 0x31D43D4;
	constexpr ptrdiff_t dwGameDir = 0x62D7F8;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52C00BC;
	constexpr ptrdiff_t dwGetAllClasses = 0xDB2D6C;
	constexpr ptrdiff_t dwGlobalVars = 0x58ECE8;
	constexpr ptrdiff_t dwGlowObjectManager = 0x52EB478;
	constexpr ptrdiff_t dwInput = 0x51F4458;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x945A44;
	constexpr ptrdiff_t dwLocalPlayer = 0xD8B2AC;
	constexpr ptrdiff_t dwMouseEnable = 0xD90E50;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xD90E20;
	constexpr ptrdiff_t dwPlayerResource = 0x31D2730;
	constexpr ptrdiff_t dwRadarBase = 0x51D7BEC;
	constexpr ptrdiff_t dwSensitivity = 0xDA215C;
	constexpr ptrdiff_t dwSensitivityPtr = 0xDA2130;
	constexpr ptrdiff_t dwSetClanTag = 0x8A1A0;
	constexpr ptrdiff_t dwViewMatrix = 0x4D94774;
	constexpr ptrdiff_t dwWeaponTable = 0x51F4F18;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
	constexpr ptrdiff_t dwYawPtr = 0xCD3A0002;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD95D50;
	...
	constexpr ptrdiff_t m_yawClassPtr = 0xD90AB0;
	constexpr ptrdiff_t m_pitchClassPtr = 0x51D7E88;
	...
	constexpr ptrdiff_t find_hud_element = 0x32F1EED0;
